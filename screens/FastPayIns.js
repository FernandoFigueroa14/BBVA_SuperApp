    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.containerLogin}>
                <ImageBackground
                    source={require("../Front_Design/Salud/fastpay.png")}
                    style={styles.imagenBack}
                >
                    <View style={styles.header}>
                        <Image
                            source={require("../Front_Design/Logos_BBVA/BBVA_FAST.png")}
                            style={styles.imagen}
                        ></Image>
                        ...
                        <Text style={styles.textAboveLight}>
                            No más terminales y todo en el mismo lugar
                        </Text>
                        <TouchableOpacity
                            onPress={() => navigation.navigate("FastPay")}
                        >
                            <Image
                                source={require("../Front_Design/Btns/abrirCamara.png")}
            ...
            <View style={styles.tabBarStyle}>
                <View style={styles.rows}>
                    ...
                    <View style={styles.containerfast}>
                        <TouchableOpacity
                            onPress={() => navigation.navigate("FastPayIns")}
                        >
                            <Image
